...
export const PaymentOrder: FC = (): ReactElement => {
  ...
  const filterData = data?.data?.filter((item) => item.isPaid === false);
        ...
        >
          <div className="flex flex-col justify-center items-center gap-y-5">
            <Icon
              ...
              width={100}
            />
            <h1>Anda Yakin Ingin Konfirmasi Pembayaran ? </h1>
          ...
          <div className="flex flex-col p-5 bg-gray-100">
            <div className="flex flex-col gap-y-2 p-4 bg-white rounded-lg shadow-md">
              ...
              <p className="mt-1 text-gray-700">
                Status :{' '}
                <span className="bg-error-500 text-white p-1 rounded-md">
                  {selectedItem.isPaid === false
                    ? 'Belum Bayar'
                    : selectedItem.status}
                </span>
              </p>
